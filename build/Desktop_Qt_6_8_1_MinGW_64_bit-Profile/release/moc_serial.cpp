...
static constexpr auto qt_meta_stringdata_ZN6SerialE = QtMocHelpers::stringData(
    "Serial",
    "gotData",
    "",
    "data",
...
Q_CONSTINIT static const uint qt_meta_data_ZN6SerialE[] = {
...
Q_CONSTINIT const QMetaObject Serial::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6SerialE.offsetsAndSizes,
    qt_meta_data_ZN6SerialE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6SerialE_t,
        // Q_OBJECT / Q_GADGET
...
void Serial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Serial::*)(QByteArray );
            if (_q_method_type _q_method = &Serial::gotData; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Serial::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6SerialE.stringdata0))
